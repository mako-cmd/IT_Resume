...
\name{Makomborero}{Mangwiro}
\position{Electronics Engineer{\enskip\cdotp\enskip}Network Engineer{\enskip\cdotp\enskip}Software Engineer{\enskip\cdotp\enskip}Tech Enthusiast}


\mobile{+61 402 908 421}
\email{makomboreroman@gmail.com}
%\dateofbirth{January 1st, 1970}
%\homepage{www.posquit0.com} 
%\github{github.com/themagicalmammal}
\linkedin{linkedin.com/in/mako-the-engineer/}
% \gitlab{gitlab-id}
...
%\input{cv/Training and Development}
...
\vspace*{\fill}
\centering{\textbf{Makomborero Mangwiro}}
%-------------------------------------------------------------------------------
\end{document}
